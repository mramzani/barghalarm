            ...
            <div class="mx-auto max-w-6xl px-4 sm:px-6 py-8 sm:py-12">
                <header class="flex items-center justify-between">
                    ...
                    <nav class="hidden md:flex items-center gap-6 text-sm">
                        ...
                        <a href="https://t.me/mazandbarghalertbot" class="text-slate-300 hover:text-white transition-colors">دریافت مازندبرق</a>
                    </nav>
                </header>
                ...
                <main>
                    <section class="mt-14 sm:mt-20 text-center">
                        ...
                        <div class="mt-10 flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4">
                            <a href="https://t.me/mazandbarghalertbot" class="inline-flex items-center justify-center rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white px-6 py-3 font-semibold shadow-lg shadow-emerald-600/20 transition-colors">
                                استفاده از مازندبرق
                            </a>
