...
<head>
    ...
    <title>مازندبرق | اطلاع‌رسانی قطعی برق مازندران</title>
    ...
    <meta name="keywords"
        content="مازندبرق, اطلاع‌رسانی قطعی برق, اطلاع‌رسانی قطعی برق مازندران, اطلاع‌رسانی قطعی برق شهرها و محله‌های استان مازندران,خاموشی برق,خاموشی برق مازندران,ساعت خاموشی مازندران">
        ...
        <div class="mx-auto max-w-6xl px-4 sm:px-6 py-8 sm:py-12">
            <header class="flex items-center justify-between">
                ...
                <nav class="hidden md:flex items-center gap-6 text-sm">
                    ...
                    <a href="https://t.me/mazandbarghalertbot"
                        class="text-slate-300 hover:text-white transition-colors">دریافت مازندبرق</a>
                </nav>
            </header>
            ...
            <main>
                <section class="mt-14 sm:mt-20 text-center">
                    ...
                    <p class="mt-6 text-base sm:text-lg md:text-xl text-slate-300 max-w-3xl mx-auto leading-8">
                        با مازندبرق، اعلان‌های فوری و دقیق درباره برنامه‌های قطعی برق شهرها و محله‌های استان مازندران را
                        دریافت کنید. ساده، سریع و همیشه در کنار شما.
                    </p>
                    <div class="mt-10 flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4">
                        <a href="https://t.me/mazandbarghalertbot"
                            class="inline-flex items-center justify-center rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white px-6 py-3 font-semibold shadow-lg shadow-emerald-600/20 transition-colors">
                            استفاده از مازندبرق
                        </a>
                        <a href="#features"
                            class="inline-flex items-center justify-center rounded-xl border border-slate-700 text-slate-200 hover:bg-slate-800 px-6 py-3 font-semibold transition-colors">
                            آشنایی با قابلیت‌ها
                        </a>
                    </div>
                </section>
            ...
            <footer class="mt-8 text-center text-slate-400 text-xs sm:text-sm flex flex-col gap-2">
                ...
                <p> ربات مازند برق هیچ ارتباطی با اداره برق ندارد و تنها
                    جهت خدمت‌رسانی به هم اهالی مازندران ایجاد شده‌است.</p>
            </footer>
        </div>
    </div>
</body>
