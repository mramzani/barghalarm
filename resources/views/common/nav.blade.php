<nav class="bg-gray-100 border-b border-gray-200 px-4 py-2.5 dark:bg-gray-800 dark:border-gray-700 fixed right-0 left-0 top-0 z-50">
    <div class="flex flex-wrap justify-between items-center">
        <div class="flex justify-start items-center">
            <a href="https://flowbite.com" class="flex mr-4">
                <img src="https://flowbite.s3.amazonaws.com/logo.svg" class="ml-3 h-8" alt="FlowBite Logo" />
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">مدیریت</span>
            </a>
        </div>
        <div class="flex items-center lg:order-2">
            ...
            <div class="hidden overflow-hidden z-50 my-4 max-w-sm text-base list-none bg-white rounded divide-y divide-gray-100 shadow-lg dark:divide-gray-600 dark:bg-gray-700" id="notification-dropdown">
                ...
                <div>
                    <a href="#" class="flex py-3 px-4 border-b hover:bg-gray-100 dark:hover:bg-gray-600 dark:border-gray-600">
                        ...
                        <div class="pr-3 w-full">
                            <div class="text-gray-500 font-normal text-sm mb-1.5 dark:text-gray-400">سفارش جدید <span class="font-semibold text-gray-900 dark:text-white">محمد استور</span> یک بنر لوکس ثبت کرده است</div>
                            <div class="text-xs font-medium text-primary-700 dark:text-primary-400">چند لحظه پیش</div>
                        </div>
                    </a>
                    {{--end div this class flex py-3 px-4 hover:bg-gray-100 dark:hover:bg-gray-600--}}
                </div>
                <a href="#" class="block py-2 text-base font-medium text-center text-gray-900 bg-gray-50 hover:bg-gray-100 dark:bg-gray-700 dark:text-white dark:hover:underline">
                    <div class="inline-flex items-center ">
                        <svg aria-hidden="true" class="ml-2 w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M10 12a2 2 0 100-4 2 2 0 000 4z"></path><path fill-rule="evenodd" d="M.458 10C1.732 5.943 5.522 3 10 3s8.268 2.943 9.542 7c-1.274 4.057-5.064 7-9.542 7S1.732 14.057.458 10zM14 10a4 4 0 11-8 0 4 4 0 018 0z" clip-rule="evenodd"></path></svg>
                        مشاهده همه
                    </div>
                </a>
            </div>
            ...
            <div class="hidden overflow-hidden z-50 my-4 max-w-sm text-base list-none bg-white rounded divide-y divide-gray-100 shadow-lg dark:bg-gray-700 dark:divide-gray-600" id="apps-dropdown">
                ...
                <div class="grid grid-cols-3 gap-4 p-4">
                    <a href="#" class="block p-4 text-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 group">
                        ...
                        <div class="text-sm font-medium text-gray-900 dark:text-white">فروشگاه ها</div>
                    </a>
                    <a href="#" class="block p-4 text-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 group">
            ...
            <button id="theme-toggle" data-tooltip-target="tooltip-dark" type="button" class="text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5">
            ...
            <button type="button" id="regionDropdownButton" data-dropdown-toggle="regionDropdown" class="hidden items-center p-2 pr-3 pl-4 font-medium text-gray-500 rounded-lg lg:inline-flex hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-700 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600">
                انتخاب سیستم
                <!-- Icon -->
                <svg class="w-3 h-3 mr-1.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"/></svg>
            </button>
                        ...
                        <div class="flex p-2 rounded hover:bg-gray-100 dark:hover:bg-gray-600">
                            ...
                            <div class="mr-2 text-sm">
                                <label for="helper-radio-4" class="font-medium text-gray-900 dark:text-gray-300">
                                    <div>مورد اول</div>
                                    <p id="helper-radio-text-4" class="text-xs font-normal text-gray-500 dark:text-gray-300">توضیحاتش</p>
                                </label>
                            </div>
                        </div>
                    </li>
                        ...
                        <div class="flex p-2 rounded hover:bg-gray-100 dark:hover:bg-gray-600">
                            ...
                            <div class="mr-2 text-sm">
                                <label for="helper-radio-5" class="font-medium text-gray-900 dark:text-gray-300">
                                    <div>مورد دوم</div>
                                    <p id="helper-radio-text-5" class="text-xs font-normal text-gray-500 dark:text-gray-300">توضیحاتش</p>
                                </label>
                            </div>
                        </div>
                    </li>
                        ...
                        <div class="flex p-2 rounded hover:bg-gray-100 dark:hover:bg-gray-600">
                            ...
                            <div class="mr-2 text-sm">
                                <label for="helper-radio-6" class="font-medium text-gray-900 dark:text-gray-300">
                                    <div>مورد سوم</div>
                                    <p id="helper-radio-text-6" class="text-xs font-normal text-gray-500 dark:text-gray-300">توضیحاتش</p>
                                </label>
                            </div>
                        </div>
                    </li>
            ...
            <div class="hidden z-50 my-4 w-56 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600" id="userDropdown">
                <div class="py-3 px-4">
                    <span class="block text-sm font-semibold text-gray-900 dark:text-white">محمد رمضانی</span>
                    <span class="block text-sm text-gray-500 truncate dark:text-gray-400">support@rinofy.shop</span>
                </div>
                ...
                <ul class="py-1 text-gray-500 dark:text-gray-400" aria-labelledby="userDropdownButton">
                    <li>
                        <a href="#" class="block py-2 px-4 text-sm hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">خروج از سیستم</a>
                    </li>
                </ul>
            </div>
